...
useHead({
  ...
  charset: 'utf-8',
  title: 'Movies Library Inspired by Nuxt',
  titleTemplate: title => title !== 'Movies Library Inspired by Nuxt' ? `${title} · Movies Library Inspired by Nuxt` : title,
  meta: [
    { name: 'description', content: 'Movie and TW Shows library with great and simple interface' },
